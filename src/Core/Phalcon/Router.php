...
use Core\Phalcon\Daemon\ServiceAwareInterface;
use Core\Phalcon\Exception\Http\CsrfException;
use Core\Phalcon\Exception\Http\NotFoundException;
...
class Router extends PhalconRouter implements ServiceAwareInterface
{
    ...
    {
        $this->_routes = [];
        $routes = is_file($file = $_SERVER['APP_ROOT_PATH'] . '/app/routes.php') ? include $file : [];
